...
class ScanTest(TestCase):
    ...
    def test_attributes(self):
        ...
        self.assertEqual(scan.seconds_per_line, 6.31264e-05)
        ...
        self.assertEqual(scan.seconds_per_line, 0.000126153)
        ...
        self.assertEqual(scan.seconds_per_line, 4.15092e-05)
...
class StackTest(TestCase):
    ...
    def test_attributes(self):
        ...
        self.assertEqual(scan.seconds_per_line, 0.000126264)
        ...
        self.assertEqual(scan.seconds_per_line, 4.15312e-05)
